        ...
        <div className="pt-10 text-white flex items-center justify-center gap-10 mx-16 h-[90vh]">
          <div className="w-1/2 space-y-6">
            ...
            <p className="text-xl text-gray-200">
              we have a large library of courses tought by highly skilled and qualified faculties at a very affordabe cost.
          ...
          <div className="w-1/2 flex items-center justify-center">
            <img src="https://www.syncfusion.com/blogs/wp-content/uploads/2020/06/15-Best-Visual-Studio-Code-Extensions-for-Web-Developers.png" alt="Hompage image" />
          </div>
        </div>
    </HomeLayout>
  )
